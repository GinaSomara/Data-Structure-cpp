#include "LinkedBag.h"
#include "Node.h"  //maybe not because LinkedBag includes Node.cpp???
...
bool LinkedBag<ItemType>::addEnd340(const ItemType& anItem)
{
    try{
        ...
        Node<ItemType>* newNodePtr = new Node<ItemType>(anItem);
...
template<typename ItemType>
int LinkedBag<ItemType>::getFrequencyOf340RecursiveHelper(Node<ItemType>* nodePtr, const ItemType& itemName) const
{
